...
ActiveRecord::Schema.define(version: 2021_03_12_023537) do
  ...
  create_table "messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["parent_user_id"], name: "index_messages_on_parent_user_id"
    t.index ["teacher_user_id"], name: "index_messages_on_teacher_user_id"
  end
  ...
  add_foreign_key "messages", "parent_users"
  add_foreign_key "messages", "teacher_users"
end
